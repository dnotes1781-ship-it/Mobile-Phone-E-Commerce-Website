...
class Customer(models.Model):
    ...
    @staticmethod
    def get_customer_by_email(email):       # identify user by email id...
        try:
    ...
    def isExists(self):
        if Customer.objects.filter(email = self.email):     # this is for checking if already registered customer email....
            return True
